...
import jp.ac.meijou.GHToDoTool.databinding.ActivityLinkPageBinding;
...
public class linkSetting extends AppCompatActivity {

    private ActivityLinkSettingBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        binding = ActivityLinkSettingBinding.inflate(getLayoutInflater());
